  ...
  return (
    <footer id="footer" className="relative z-50 dark:bg-gray-900 pt-24">
              ...
              <div className="w-full lg:w-1/2 px-6">
                <ul>
                  ...
                  <li className="mt-6">
                    <Link href="javascript:void(0)">
                      <span
                        className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">Templates</span>
                    </Link>
                  </li>
                  <li className="mt-6">
                    <Link href="javascript:void(0)">
                      <span
                        className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">Pricing</span>
                    </Link>
                  </li>
                  <li className="mt-6">
                    <Link href="javascript:void(0)">
                      <span
                        className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">FAQ</span>
                    </Link>
                  </li>
                  <li className="mt-6">
                      <span
              ...
              <div className="w-full lg:w-1/2 px-6">
                <ul>
                  <li>
                    <Link href="javascript:void(0)">
                      <span
                        className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">Free components</span>
                    </Link>
                  </li>
                  ...
                  <li className="mt-6">
                    <Link href="javascript:void(0)">
                      <span
                        className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">Changelog</span>
                    </Link>
                  </li>
                </ul>
              </div>
              ...
              <div className="w-full lg:w-1/2 px-6">
                <ul>
                  ...
                  <li className="mt-6">
                    <Link href="javascript:void(0)">
                      <span
                        className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">Terms of service</span>
                    </Link>
                  </li>
                </ul>
              </div>
              <div className="w-full lg:w-1/2 px-6 flex flex-col justify-between">
                <div className="flex items-center mb-6">
                    <span>
                      <div
                        ...
                        <svg className="footer-icon feather feather-github" xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="relative w-36">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg"
                       ...
                       width={16} height={16} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none"
                       strokeLinecap="round" strokeLinejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
      ...
      <div className="py-16 flex flex-col justify-center items-center">
        <Link href="javascript:void(0)">
            <span>
              <svg className="dark:text-white" xmlns="http://www.w3.org/2000/svg" width={86} height={58}
                ...
                <path d="M0 0V9.76985H10.5059V39.1479H21.6851V9.78371H23.4139V10.3298H33.9084V0H0Z"
                      fill="currentColor"/>
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
        ...
        <p className="mt-6 text-xs lg:text-sm leading-none text-gray-900 dark:text-gray-50">2021 Tailwind UI Kit. All
          Rights Reserved.</p>
      </div>
    </footer>
  );
